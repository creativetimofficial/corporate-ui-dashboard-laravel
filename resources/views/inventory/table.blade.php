                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center ms-1">
                                                        ...
                                                        <p class="text-sm text-secondary mb-0">{{ $p->name }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        <td>
                                            <p class="text-sm text-dark font-weight-semibold mb-0">{{ $p->name }}</p>
                                            <p class="text-sm text-secondary mb-0">{{ $p->name }}</p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="badge badge-sm border border-success text-success bg-success">{{ $p->name }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-sm font-weight-normal">{{ $p->name }}</span>
                                        </td>
                                        <td >
                                            <div class="input-group">
                                                <button class="btn btn-outline-secondary custom-btn " type="button" onclick="updateQuantity({{ $p->id }}, -1)">-</button>
                                                <input type="text" class="custom-input" id="quantity-{{ $p->id }}" value="{{ $p->quantity }}" readonly>
                                                <button class="btn btn-outline-secondary custom-btn" type="button" onclick="updateQuantity({{ $p->id }}, 1)">+</button>
                                            </div>
                                        </td>
                                        <td>
